 ...
 *
 * É uma lista encadeada onde vários callbacks podem ser registrados para um mesmo evento.
 *
 * Tem duas especializações: Uma para callback que são funções e outra para métodos de
 * uma instância de objetos.
 */
